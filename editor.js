...
const ScaledRectangleEditor = L.Editable.RectangleEditor.extend({
  ...
  extendBounds(e) {
    if (!e) {
      const vertex  = this.getLatLngs()[0][0].__vertex;
      e = { vertex: vertex, latlng: vertex.getLatLng()}
    }

    if (this.ratio == 0) {
      return L.Editable.RectangleEditor.prototype.extendBounds.call(this, e);
    }

    const selected  = e.vertex
